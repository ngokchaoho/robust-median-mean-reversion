...
#input
pathname <- file.path(path,'nyse-o.mat')
...
write.csv(file = "nyse-o.csv",rmr_result)
plot(seq(from = 1, to = t),t(rmr_result[[2]]),col="black",type="l",ylim=c(0,1000),xlab="TIME",ylab="TOTAL WEALTH in NYSE-O")


tc=0
fid="rmr-arma-nyse-o.csv"
...
title("Total Wealth of Different Strategies in nyse-o",lwd=3)
