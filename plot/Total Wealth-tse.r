...
plot(seq(from = 1, to = t),t(rmr_result[[2]]),col="black",type="l",ylim=c(0,70),xlab="TIME",ylab="TOTAL WEALTH in TSE")


tc=0
fid="rmr-arma-tse.csv"
...
title("Total Wealth of Different Strategies in TSE",lwd=3)
